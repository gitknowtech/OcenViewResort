    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try (Connection conn = DriverManager.getConnection(url, dbUser, dbPassword);
                ...
                out.println("<html><head><title>Table Created</title>");
                out.println("<style>");
                out.println("body { font-family: Arial, sans-serif; margin: 40px; background: #f5f5f5; }");
                out.println(".container { background: white; padding: 30px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); max-width: 600px; }");
                ...
                out.println("<h2>✅ Staff Table Created Successfully!</h2>");
                
                out.println("<div class='success'>");
                out.println("<strong>🎉 Staff management table is ready!</strong>");
                out.println("</div>");

                out.println("<div class='table-info'>");
                out.println("<div class='table-name'>👔 STAFF TABLE</div>");
                out.println("<strong>Fields:</strong>");
                out.println("<ul>");
                out.println("<li><span class='required'>id</span> - Auto-generated primary key</li>");
                out.println("<li><span class='required'>name</span> - Full name (required)</li>");
                out.println("<li><span class='required'>username</span> - Unique username (required)</li>");
                out.println("<li><span class='required'>email</span> - Unique email (required)</li>");
                out.println("<li><span class='required'>password</span> - Hashed password (required)</li>");
                out.println("<li><span class='required'>phone</span> - Phone number (required)</li>");
                out.println("<li><span class='default'>position</span> - Position (default: 'Staff')</li>");
